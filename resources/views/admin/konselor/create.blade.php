            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">Tambah Konselor</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('list.konselor.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('jenis_konselor') is-invalid @enderror"
                                            ...
                                            <option value="Konselor HKSR"
                                                {{ old('jenis_konselor') == 'Konselor HKSR' ? 'selected' : '' }}>Konselor
                                                HKSR</option>
                                            <option value="Konselor Mental"
                                                {{ old('jenis_konselor') == 'Konselor Mental' ? 'selected' : '' }}>Konselor
                                                Mental</option>
                                            <option value="Konselor Sebaya"
                                                {{ old('jenis_konselor') == 'Konselor Sebaya' ? 'selected' : '' }}>Konselor
                                                Sebaya</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="time"
                                            ...
                                            id="jam_aktif_awal" name="jam_aktif_awal" value="{{ old('jam_aktif_awal') }}"
                                            required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="time"
                                            ...
                                            value="{{ old('jam_aktif_akhir') }}" required>
